...
This document explains the processes and practices recommended for contributing enhancements to the %%CHARM_DISPLAY_NAME%% charm.

## Overview

- Generally, before developing enhancements to this charm, you should consider [opening an issue
  ](https://github.com/%%GITHUB_REPO%%/issues) explaining your use case.
...
adding an entry to the [CHANGELOG.md](%%PATH_CHANGELOG%%) file. Use the date of the
...
- [Fork](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks)
  our [GitHub repository](https://github.com/%%GITHUB_REPO%%)
...
Canonical welcomes contributions to the %%CHARM_DISPLAY_NAME%% charm. Please check out our
...
OCI image for the %%CHARM_DISPLAY_NAME%% app, and then upload the image to a MicroK8s registry,
